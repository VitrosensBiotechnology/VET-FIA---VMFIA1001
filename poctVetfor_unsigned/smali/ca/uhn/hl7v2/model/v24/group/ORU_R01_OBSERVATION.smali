.class public Lca/uhn/hl7v2/model/v24/group/ORU_R01_OBSERVATION;
.super Lca/uhn/hl7v2/model/AbstractGroup;
.source "ORU_R01_OBSERVATION.java"
...
.method public constructor <init>(Lca/uhn/hl7v2/model/Group;Lca/uhn/hl7v2/parser/ModelClassFactory;)V
    ...
    .line 16
    invoke-direct {p0, p2}, Lca/uhn/hl7v2/model/v24/group/ORU_R01_OBSERVATION;->init(Lca/uhn/hl7v2/parser/ModelClassFactory;)V
...
.method private init(Lca/uhn/hl7v2/parser/ModelClassFactory;)V
    ...
    invoke-virtual {p0, v0, v1, v1, v1}, Lca/uhn/hl7v2/model/v24/group/ORU_R01_OBSERVATION;->add(Ljava/lang/Class;ZZZ)Ljava/lang/String;
    :try_end_0
    ...
    sget-object v1, Lca/uhn/hl7v2/model/v24/group/ORU_R01_OBSERVATION;->log:Lorg/slf4j/Logger;

    const-string v2, "Unexpected error creating ORU_R01_OBSERVATION - this is probably a bug in the source code generator."
...
.method public getOBX()Lca/uhn/hl7v2/model/v24/segment/OBX;
    ...
    invoke-virtual {p0, v0, v1}, Lca/uhn/hl7v2/model/v24/group/ORU_R01_OBSERVATION;->getTyped(Ljava/lang/String;Ljava/lang/Class;)Lca/uhn/hl7v2/model/Structure;
