.class public Lca/uhn/hl7v2/model/v24/group/ORF_R04_PATIENT;
.super Lca/uhn/hl7v2/model/AbstractGroup;
.source "ORF_R04_PATIENT.java"
...
.method public constructor <init>(Lca/uhn/hl7v2/model/Group;Lca/uhn/hl7v2/parser/ModelClassFactory;)V
    ...
    .line 16
    invoke-direct {p0, p2}, Lca/uhn/hl7v2/model/v24/group/ORF_R04_PATIENT;->init(Lca/uhn/hl7v2/parser/ModelClassFactory;)V
...
.method private init(Lca/uhn/hl7v2/parser/ModelClassFactory;)V
    ...
    invoke-virtual {p0, v0, v1, v2, v2}, Lca/uhn/hl7v2/model/v24/group/ORF_R04_PATIENT;->add(Ljava/lang/Class;ZZZ)Ljava/lang/String;
    :try_end_0
    ...
    sget-object v1, Lca/uhn/hl7v2/model/v24/group/ORF_R04_PATIENT;->log:Lorg/slf4j/Logger;

    const-string v2, "Unexpected error creating ORF_R04_PATIENT - this is probably a bug in the source code generator."
...
.method public getPID()Lca/uhn/hl7v2/model/v24/segment/PID;
    ...
    invoke-virtual {p0, v0, v1}, Lca/uhn/hl7v2/model/v24/group/ORF_R04_PATIENT;->getTyped(Ljava/lang/String;Ljava/lang/Class;)Lca/uhn/hl7v2/model/Structure;
